...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'mobile_auth',
          path: '/mobileAuth',
          builder: (context, params) => MobileAuthWidget(),
        ),
        FFRoute(
          name: 'App_lock',
          path: '/appLock',
          builder: (context, params) => AppLockWidget(),
        ),
        FFRoute(
          name: 'Home_Page',
          path: '/homePage',
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailTransactionsWidget(),
        ),
        FFRoute(
          name: 'Add_account',
          path: '/addAccount',
        ...
        FFRoute(
          ...
          path: '/addNewAccount',
          builder: (context, params) => AddNewAccountWidget(),
        ),
        FFRoute(
          name: 'Success',
          path: '/success',
        ...
        FFRoute(
          name: 'Budget_Detail',
          path: '/budgetDetail',
          builder: (context, params) => BudgetDetailWidget(),
        ),
        FFRoute(
          name: 'Create_Budget',
          path: '/createBudget',
        ...
        FFRoute(
          name: 'Edit_Budget',
          path: '/editBudget',
          builder: (context, params) => EditBudgetWidget(),
        )
