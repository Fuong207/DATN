  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: FlutterFlowTheme.of(context).greenC,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    var incomeRecordReference = IncomeRecord.collection.doc();
                    await incomeRecordReference.set(createIncomeRecordData(
                      userRef: currentUserReference,
                      category: _model.dropDownValue1,
                      incomeBalance:
                          double.tryParse(_model.textController1.text),
                      accountId: _model.accountId,
                      incomeDesc: _model.textController2.text,
                      document: _model.uploadedFileUrl,
                      incomeMonth: dateTimeFormat('MMMM', getCurrentTimestamp),
                    ));
                    _model.incomeData = IncomeRecord.getDocumentFromData(
                        createIncomeRecordData(
                          userRef: currentUserReference,
                          category: _model.dropDownValue1,
                          incomeBalance:
                              double.tryParse(_model.textController1.text),
                    ...
                    _model.incomeUpdate = await queryAccountsRecordOnce(
                    ...
                    await _model.incomeUpdate!.reference.update({
                      ...mapToFirestore(
                        {
